...
watch(productsFormatted, (newVal) => {
  const itemsNoCheck = newVal.some((e) => {
...
<template>
      ...
      <div class="flex gap-2 items-center py-6">
        <router-link to="/">
          <div class="flex items-center gap-4">
            <div class="pb-2 w-32 fill-orange-600">
              <svg
                viewBox="0 0 192 65"
            ...
            <div class="h-8 border-r border-orange-600"></div>

            <div class="text-xl whitespace-nowrap text-orange-600">
              Giỏ Hàng
            </div>
          </div>
        </router-link>
  ...
  <div class="w-[1200px] mx-auto" v-if="hasProductsInCart">
    ...
    <!-- Header title -->
    <div
      class="flex items-center mt-2 rounded-sm text-sm text-gray-500 h-[55px] px-12 bg-white"
    >
      <input
        type="checkbox"
        class="w-4 h-4 mr-4"
        v-model="checkProductAll"
        :onchange="onChangeCheckAll"
      />

      <div class="w-2/4">Sản Phẩm</div>

      <div class="w-1/6 text-center">Đơn Giá</div>

      <div class="w-1/6 text-center">Số Lượng</div>

      <div class="w-1/6 text-center">Số Tiền</div>

      <div class="w-1/6 text-center">Thao Tác</div>
    </div>

    <!-- Body -->
    <div class="bg-white border-b my-4">
      <!-- Product item -->
      <div class="p-4">
        <div class="border">
          <div
          ...
          >
            ...
            <!-- Img -->
            <div class="w-1/12 h-2/4 bg-blue-200">
              <img :src="product.image" class="w-full h-full object-fit" />
            </div>

            <!-- Des -->
            <div
              class="w-5/12 pl-2 line-clamp-2 overflow-hidden line-height-1.25"
            >
              {{ product.description }}
            </div>

            <!-- Price -->
            <div class="w-1/6 text-center">{{ product.price }} dollars</div>

            <!-- Quantity -->
            <div class="w-1/6 flex justify-center items-center border">
              <div
                class="w-1/4 border-r cursor-pointer text-center"
              ...
              <input
                ...
                class="w-2/4 border-r text-center text-black"
              />

              <div
                class="w-1/4 cursor-pointer text-center"
            ...
            <!-- Total price -->
            <div class="w-1/6 text-center text-orange-600">
              {{ product.price * product.quantity }} dollars
            </div>
      ...
      <!-- Voucher shop apply -->
      <div
        class="px-12 py-4 bg-white text-sm text-blue-600 border-b border-t flex items-center gap-2"
      >
        <svg
          xmlns="http://www.w3.org/2000/svg"
          class="icon icon-tabler icon-tabler-ticket text-orange-600"
          width="18"
          height="18"
          viewBox="0 0 24 24"
          stroke-width="1"
      ...
      <!-- Freeship title -->
      <div class="px-12 py-4 bg-white text-sm flex items-center gap-2">
        <div class="w-6 h-6">
          <img
            src="https://deo.shopeemobile.com/shopee/shopee-pcmall-live-sg/d9e992985b18d96aab90969636ebfd0e.png"
          />
        ...
        <span
          ...
          vận chuyển đơn tối thiểu ₫150.000 Tìm hiểu thêm</span
        >
      </div>
    </div>
    ...
    <div class="bg-white text-sm">
      <div class="p-4 flex">
        ...
        <div class="w-2/6 flex justify-between">
          ...
          <span class="text-blue-600">Chọn hoặc nhập mã</span>
        </div>
      </div>

      <div class="p-4 border-y border-dotted"></div>

      <div class="p-4 flex justify-between items-center text-base">
        <div class="flex items-center gap-4">
          <input
            type="checkbox"
            class="w-4 h-4 mr-4"
        ...
        <div class="flex items-center gap-2">
          <span
            >Tổng Thanh Toán ({{ onReturnCheckoutValues().totalQuantity }} Sản
            Phẩm):
          </span>
