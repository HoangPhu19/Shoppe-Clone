export default {
  ...
  indicators: ({ parent }) => ({
    class: [
      ...
      {
        "absolute z-10 ": parent.props.showIndicatorsOnItem,
      },
  ...
  indicatorbutton: ({ context }) => ({
    class: [
      ...
      {
        "bg-orange-200 hover:bg-surface-300 dark:bg-surface-700 dark:hover:bg-orange-600":
          !context.highlighted,
      },

      // Conditional Appearance: Highlighted
      { "bg-orange-500 hover:bg-orange-600": context.highlighted },
    ],
  }),
  mask: {
    class: [
